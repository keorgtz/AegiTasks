...
- **Lista y tablero:** buscador y botón de filtros con contador de ajustes activos. El diálogo reúne proyecto, carpeta, estado, responsable, etiqueta, prioridad, alcance y orden; permite aplicar, cancelar o restablecer conservando la búsqueda. El tablero funciona directamente en la bandeja, agrupado por proyecto con sus estados personalizados. Cambiar de vista mantiene los filtros y la página; lista y tableros muestran los mismos 50 elementos por página.
